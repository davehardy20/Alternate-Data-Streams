...
# describes the function Invoke-ADS
Describe 'Invoke-ADS' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { Invoke-ADS } | Should Not Throw
    }
    It 'does something' {
      # call function Invoke-ADS and pipe the result to an assertion
      # Example:
      # Invoke-ADS | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      Invoke-ADS | Should BeNullOrEmpty 
    }
  }
}
